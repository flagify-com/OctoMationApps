 ...
 */
public class AddCollectionElementTest {

    @Test
    public void testAddCollectionElement(){
        AddCollectionElement addCollectionElement = new AddCollectionElement();
        String params = "{\"collectionName\":\"test_2_33\",\"value\":\"192.168.1.20\",\"remark\":\"123\"}";
        ...
        Result result = addCollectionElement.invoke(jsonObject, config);
        System.out.print(JSONObject.toJSONString(result));
    }

    @Test
    public void testAddCollectionElementAddEffectiveTime(){
        AddCollectionElement addCollectionElement = new AddCollectionElement();
        String params = "{\"collectionName\":\"test_2_33\",\"value\":\"192.168.1.20\",\"remark\":\"123\",\"expireTime\":\"2022-09-02 12:00:00\",\"effectiveTime\":\"2022-03-02 12:00:00\"}";
        JSONObject jsonObject = JSONObject.parseObject(params);
        JSONObject config = new JSONObject();
        config.put("appToken", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJ4dWhvbmdyb25nIiwic3ViIjoiT3BlbkFQSSBvZiB3dXpoaS1haS5jb20iLCJhcHBJZCI6NTE0MTg5NzA2NjgwODQ4OCwiaXNzIjoid3V6aGktYWkuY29tIiwiZXhwIjoxNjMwMzI2NTcxLCJpYXQiOjE2MzAzMjI5NzF9.CFIizQXNTnq1Nz-k148qu5ULAjOEp-IbabjTkp3jjQo");
        config.put("serverAddress", "http://mgmt.sp.com:9100");
